void pantallaInicio(){
  ...
  fondo1 = loadImage("fondo1.jpg");
    ...
    textSize(15);
           ...
           text("Al mantener precionada la tecla correspondiente a cada ilustración", 115,290);
           text("Se reproducirá un video. Para cerrar el video se presiona la tecla S", 45,310);
